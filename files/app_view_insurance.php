...
?>
            ...
            <html>
                <head>
                    <title>View Your Insurance</title>
                    <meta charset="utf-8" />
                                    ...
                                    <div class="inner">
                                        ...
                                        <!-- Header -->
                                            ...
                                            <?php
                                                ...
                                                $sql = "SELECT * FROM Insurance, Applicant, Policy WHERE Applicant.App_ssn = '$App_ssn' and Applicant.App_ssn = Policy.App_ssn and Policy.Ins_id = Insurance.Ins_id;";
